...
\begin{tikzpicture}
  ...
  \coordinate (z) at (2.6,0);
  \coordinate (w) at (3.9,0);

  % Porte logiche
  \node [not gate US, draw, rotate=270] (notx) at ([xshift=6mm,yshift=-6mm]x),-0.6){};
  \node [not gate US, draw, rotate=270] (noty) at ([xshift=6mm,yshift=-6mm]y),-0.6){};
  \node [not gate US, draw, rotate=270] (notz) at ([xshift=6mm,yshift=-6mm]z),-0.6){};
  \node [not gate US, draw, rotate=270] (notw) at ([xshift=6mm,yshift=-6mm]w),-0.6){};


  \node [and gate US, draw, logic gate inputs=nnnn] (and1) at (6,-2.5){$\overline{x}\overline{y}\overline{z}\overline{w}$};
  ...
  \node [or gate US, draw, right=of and4, xshift=7mm, yshift=-5mm, logic gate inputs=nnnnnnn] (or){};
